        ...
        <form method="POST" enctype="multipart/from-data">
            <div class="container">
                <div class="row rounded p-2" style="background-color:#f2f2f2">
                    ...
                    <div class="col text-center"><b>NOME</b></div>
                    <div class="col text-center"><b>EMAIL</b></div>
                    <div class="col text-center"><b>ADMIM</b></div>
                ...
                <div class="row rounded p-3">
                    <div class="col-1 text-center"></div>  
                    <div class="col text-center"><b style="color:#0EA5E9">{{ $usuario->ID }}</b></div>
                    <div class="col text-center">{{ $usuario->nome }}</div>
                    <div class="col text-center">{{ $usuario->email }}</div>
