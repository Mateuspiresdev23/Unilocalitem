        ...
        <div class="col-12">
            ...
            @forelse ($items as $item)
                <div class="card">
                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img  src="{{ asset('/img/logo.png') }}" height="250" width="300">
                        </div>
                        <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text text-secondary mb-2">Manifestado por: ADM 14/02/2023 00:00:00</p>
                            <div class="row justify-content-end">
                                <div class="form-group col-sm-12 col-md-6 mb-3 text-end"> 
                                    ...
                                    &nbsp
                                    <button class="btn btn-primary" style="background: rgba(8, 192, 26, 1); outline: none;" type="submit" >Concluir</button>
                                </div>
                            </div>
                        </div>
                        </div>
